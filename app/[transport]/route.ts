...
const FindMatchingVehicleInput = z.object({
  ...
  vehicleType: z.string().optional().describe("Finer body classification than bodyType, e.g. Crossover, SUV, Sedan, Wagon, Minivan, Performance/Sports, Hybrid, Hatchback, Coupe, Luxury, Electric. Confirmed conflict: vehicleType \"Sedan\" combined with a luxury sedan model (e.g. Mercedes E-Class, Audi A6) silently returns zero, because that listing is tagged Luxury there instead of Sedan — even though the car exists and bodyType \"Sedan\" finds it fine. This conflict is confirmed for Sedan specifically; Coupe does NOT have it (confirmed: vehicleType \"Coupe\" + Lexus RC, a luxury coupe, works correctly). For a plain body-style request, prefer bodyType — it doesn't have this conflict. If a Sedan request involves a premium/luxury make or model, use bodyType \"Sedan\" rather than vehicleType \"Sedan\"."),
