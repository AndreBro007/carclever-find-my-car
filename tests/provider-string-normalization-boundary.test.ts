...
// ===========================================================================
{
  ...
  check(
    "17. lower_risk dispatch branch untouched (still present, unrelated to this diff, now fed by electrificationFilteredCandidates + electrificationMatchOf per [unverified citation removed])",
